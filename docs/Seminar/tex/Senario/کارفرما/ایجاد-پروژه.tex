...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{Diagram/2.Activity/کارفرما/مدیریت-پروژه-ایجاد.png}
	\caption{دیاگرام فعالیت ایجاد پروژه}
	\label{fig:a:ایجاد-پروژه}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{Diagram/3.StateMachine/کارفرما/مدیریت-پروژه-ایجاد.png}

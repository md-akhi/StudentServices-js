...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{Diagram/2.Activity/ورود.png}
	\caption{دیاگرام فعالیت ورود}
	\label{fig:a:ورود}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=.8\textwidth]{Diagram/3.StateMachine/ورود.png}
\caption{دیاگرام حالت ماشین ورود}
\label{fig:sm:ورود}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{Diagram/4.Collaboration/1.Sequence/ورود.png}
